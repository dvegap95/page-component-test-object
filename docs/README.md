...
| [Project structure](./project-structure.md) | `__pco__` layout, factories vs API mocks, import boundaries |
| [Consumer install manifest](./CONSUMER_INSTALL.md) | Tarballs + peer deps for external monorepos |
| [Publishing](./PUBLISH.md) | npm org, versioning, CI publish workflow |
