...
```bash
pnpm add @page-component-object/router-react
```
...
`router-react` in the [page-component-test-object](https://github.com/dvegap95/page-component-test-object) monorepo.
