...
```bash
pnpm add @page-component-object/adapter-jest
```
...
`adapter-jest` in the [page-component-test-object](https://github.com/dvegap95/page-component-test-object) monorepo.
