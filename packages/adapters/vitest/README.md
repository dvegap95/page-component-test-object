...
```bash
pnpm add @page-component-object/adapter-vitest
```
...
`adapter-vitest` in the [page-component-test-object](https://github.com/dvegap95/page-component-test-object) monorepo.
