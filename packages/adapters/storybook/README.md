...
Storybook — `createStoryPlay`, `storyParameters`, MSW bridge. **Do I need this?** For Storybook `play` functions and shared MSW stories.

## Install

```bash
pnpm add @page-component-object/adapter-storybook
```
...
`adapter-storybook` in the [page-component-test-object](https://github.com/dvegap95/page-component-test-object) monorepo.
